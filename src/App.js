    ...
    <main class="bg-gray-100 h-full relative">
      <div class="flex flex-col w-full pl-0 md:p-4 md:space-y-4 mt-2">
        ...
        <section className="grid grid-cols-12 gap-4">
          {/* map container */}
          <div class="col-start-1 col-end-7 p-4 w-full shadow-lg bg-white dark:bg-gray-700 items-center h-full rounded-2xl z-40">
            <MapChartComponent />
          </div>
          {/* graphs centroids container*/}
          <div class="col-span-6 p-4 w-full shadow-lg bg-white dark:bg-gray-700 items-center h-full rounded-2xl z-40">
